...
const restructureOldConfig = (old: any) => {
    ...
    const remapped: TxConfigs = {
        ...
        fxserver: {
            enforceGameBuild: null,
            replaceExeToSwitchBuilds: null,
            pureLevel: null,
            enableNetworkedSounds: null,
            enableNetworkedPhoneExplosions: null,
            enableNetworkedScriptEntityStates: null,
            experimentalStateBagsHandler: null,
            experimentalOnesyncPopulation: null,
            experimentalNetGameEventHandler: null,
            poolSizes: [],
            endpointPrivacy: null,
            httpFileServerProxyOnly: null,
            stateBagStrictMode: null,
            protectServerEntities: null,
            steamWebApiKey: null,
            steamWebApiDomain: null,
            tebexSecret: null,
            playersToken: null,
            profileDataToken: null,
            listingIpOverride: null,
            listingHostOverride: null,
            endpoints: null,
            onesyncLogFile: null,
            onesyncAutomaticResend: null,
            useAccurateSends: null,
        },
    }
